...
namespace SM.WEB.Controller
{
    ...
    /// warehouseById 的摘要说明
    /// </summary>
    public class warehouseById : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = string.Format(@"SELECT * from Warehouse where 1=1  {0} ", sqlwhere);
