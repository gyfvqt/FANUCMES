...
{
    /// <summary>
    /// PLCTemplateInfoSearch 的摘要说明
    /// </summary>
    public class PLCTemplateInfoSearch : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = string.Format(@"select * from PLCTemplateInfo(nolock) where 1=1 {0}", sqlwhere);
