...
{
    /// <summary>
    /// PLCUPInfoSearch 的摘要说明
    /// </summary>
    public class PLCUPInfoSearch : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = string.Format(@"select * from PLCUPInfo(nolock) where 1=1 {0}", sqlwhere);
