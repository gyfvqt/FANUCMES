...
namespace SM.WEB.Controller
{
    ...
    /// AndonSearch 的摘要说明
    /// </summary>
    public class AndonSearch : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlCount = string.Format(@"select count(1) from  [AndonConfiguration](nolock)  a
...
FROM    ( SELECT TOP ( {0} * {1} )
                    ...
                    a.*
            FROM  AndonConfiguration(nolock)  a   
where 1=1  {2}  
        ) AS temp
