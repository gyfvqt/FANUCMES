...
{
    /// <summary>
    /// AMTicketSearch 的摘要说明
    /// </summary>
    public class AMTicketSearch : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
...
FROM    ( SELECT TOP ( {0} * {1} )
                    ...
                    a.*,b.LastName+b.FirstName as CreateName,c.LastName+c.FirstName as Executor,a.ID as XID
