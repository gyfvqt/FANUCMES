...
namespace SM.WEB.Controller
{
    ...
    /// getLineByID 的摘要说明
    /// </summary>
    public class getLineByID : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = string.Format(@"SELECT * from LineInfo where 1=1  {0} ", sqlwhere);
