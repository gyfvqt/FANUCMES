...
{
    /// <summary>
    /// PLCUPInfoDeleteByid 的摘要说明
    /// </summary>
    public class PLCUPInfoDeleteByid : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                if (ID.Trim() != "")
                {
                    sql += string.Format(@"delete from PLCUPInfo  where PLCUPId =N'{0}';", ID);
