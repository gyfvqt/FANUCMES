...
{
    /// <summary>
    /// getRoleCombobox 的摘要说明
    /// </summary>
    public class getRoleCombobox : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = @"SELECT ID id,RoleName as text from UserRole(nolock)";
