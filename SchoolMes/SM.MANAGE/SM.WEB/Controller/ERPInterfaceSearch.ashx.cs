...
{
    /// <summary>
    /// ERPInterfaceSearch 的摘要说明
    /// </summary>
    public class ERPInterfaceSearch : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = @"select * from  [ERPInterface](nolock) ";
