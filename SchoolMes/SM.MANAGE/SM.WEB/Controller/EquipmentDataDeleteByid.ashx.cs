...
{
    /// <summary>
    /// EquipmentDataDeleteByid 的摘要说明
    /// </summary>
    public class EquipmentDataDeleteByid : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                if (ID.Trim() != "")
                {
                    sql += string.Format(@"delete from EquipmentData  where ID =N'{0}';", ID);
