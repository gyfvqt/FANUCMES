...
namespace SM.WEB.Controller
{
    ...
    /// getUserById 的摘要说明
    /// </summary>
    public class getUserById : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = string.Format(@"SELECT * from UserInfo where 1=1  {0} ", sqlwhere);
