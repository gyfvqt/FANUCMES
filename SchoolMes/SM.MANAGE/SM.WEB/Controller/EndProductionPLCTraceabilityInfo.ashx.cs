...
{
    /// <summary>
    /// EndProductionPLCTraceabilityInfo 的摘要说明
    /// </summary>
    public class EndProductionPLCTraceabilityInfo : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
...
FROM    ( SELECT TOP ( {0} * {1} )
                    ...
                    a.ID,a.StationName,a.PLCDataDesc,a.UpdateTime as UpdateTimeA,a.PLCDataResult,a.LastStatus,a.Updator,b.ID as Pid
