...
{
    /// <summary>
    /// ERPInterfaceRuleSearch 的摘要说明
    /// </summary>
    public class ERPInterfaceRuleSearch : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = @"select * from  [ERPInterfaceRule](nolock) ";
