...
namespace SM.WEB.Controller
{
    ...
    /// PickListSeach 的摘要说明
    /// </summary>
    public class PickListSeach : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string PickCode = HttpContext.Current.Request.Params["pickCode"];
                ...
                if (PickCode.Trim() != "")
                {
                    sqlwhere += " AND a.PickCode like N'%" + PickCode.Trim() + "%'";
                }
                if (DeliverWay.Trim() != "")
                {
                ...
                string sqlCount = string.Format(@"select count(1) from PickList(nolock) a
