...
namespace SM.WEB.Controller
{
    ...
    /// materialById 的摘要说明
    /// </summary>
    public class materialById : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = string.Format(@"SELECT * from MaterialData where 1=1  {0} ", sqlwhere);
