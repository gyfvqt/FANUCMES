...
namespace SM.WEB.Controller
{
    ...
    /// systemLogs 的摘要说明
    /// </summary>
    public class systemLogs : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlCount = string.Format(@"select count(1) from  [SystemLogs](nolock)  a
