...
namespace SM.WEB.Controller
{
    ...
    /// errorLogs 的摘要说明
    /// </summary>
    public class errorLogs : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlCount = string.Format(@"select count(1) from  [ErrorLogs](nolock)  a
