...
namespace SM.WEB.Controller
{
    ...
    /// StationById 的摘要说明
    /// </summary>
    public class StationById : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sqlSearch = string.Format(@"SELECT * from StationInfo where 1=1  {0} ", sqlwhere);
