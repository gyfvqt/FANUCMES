...
{
    /// <summary>
    /// AMTicketSplitSearch 的摘要说明
    /// </summary>
    public class AMTicketSplitSearch : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                if (FaultName.Trim() != "")
                {
                    sqlwhere += " AND a.TicketName like N'%" + FaultName.Trim() + "%'";
                }
                ...
                string sqlCount = string.Format(@"select count(1) from AMTicket(nolock) a 
...
FROM    ( SELECT TOP ( {0} * {1} )
                    ...
                    a.*,b.LastName+b.FirstName as CreateName,c.LastName+c.FirstName as Executor,a.ID as XID,d.ID as SID,d.TicketDetailCode,d.ExecuteDate,d.Stratus,d.UpdateTime as SUpdateTime
