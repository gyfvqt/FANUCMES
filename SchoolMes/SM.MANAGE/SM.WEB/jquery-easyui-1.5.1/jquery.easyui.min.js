...
function init(_5c1){
    $(_5c1).addClass("calendar").html(
        ...
        //+ "<div class=\"calendar-title\">" + "<span class=\"calendar-text\"></span>" + "</div>"
        //+ "</div>" +
        "<div class=\"calendar-body\">" + "<div class=\"calendar-menu\">" + "<div class=\"calendar-menu-year-inner\">" + "<span class=\"calendar-nav calendar-menu-prev\"></span>" + "<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>" + "<span class=\"calendar-nav calendar-menu-next\"></span>" + "</div>" + "<div class=\"calendar-menu-month-inner\">" + "</div>" + "</div>" + "</div>");
...
var _5c9=opts.current;
    ...
    if (t.hasClass("calendar-selected")) {
        t.removeAttr("style");
        t.removeClass("calendar-selected");
    }
    else {
        t.removeAttr("style");
        t.addClass("calendar-selected");
...
cls+=" calendar-sunday";
    ...
    if (j == 1) {
        cls += " calendar-tuesday";
    }
    if (j == 2) {
        cls += " calendar-wednesday";
    }
    if (j == 3) {
        cls += " calendar-thursday";
    }
    if (j == 4) {
        cls += " calendar-friday";
    }
...
cls+=" calendar-disabled";
    ...
    if (cls.indexOf("calendar-disabled") > 0) { data.push("<td ></td>");}
    else { data.push("<td class=\"" + cls + "\" abbr=\"" + s + "\" style=\"" + _5e6 + "\">" + d + "</td>");}
