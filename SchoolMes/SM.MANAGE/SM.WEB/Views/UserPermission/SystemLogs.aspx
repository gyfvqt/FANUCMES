<%@ Page Title="" Language="C#" MasterPageFile="~/PageM.Master" AutoEventWireup="true" CodeBehind="SystemLogs.aspx.cs" Inherits="SM.WEB.Views.UserPermission.SystemLogs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="/kendoui.core/js/kendo.datetimepicker.min.js"></script>--%>
    <asp:Label runat="server" ID="lblPage" Visible="false" Text="用户操作日志"></asp:Label>
    <section id="main" role="main">
        ...
        <div style="height: 28px;">
            <span style="font-weight: bold; text-transform: uppercase; font-size: 16px; color: #444; float: left; margin-left: 12px; margin-top: 10px;">当前页面:系统管理\用户操作日志</span>
        </div>
    ...
    <script type="text/javascript">        
        ...
        function datagridfresh(pageNumber, pageSize, DTSTART, DTEND) {
            ...
            $.post('/Controller/SystemLogs.ashx', { pageindex: pageNumber, pagesize: pageSize, dtstart: DTSTART, dtend: DTEND }, function (data) {
                ...
                if (data.rows[0].tips == "没有数据") {
                    ...
                    $("#datawin").datagrid({
                        ...
                        columns: [[
                            ...
                            { field: '时间', width: 100, title: '时间' },
                            { field: '用户ID', width: 100, title: '用户ID' },
                            { field: '姓名', width: 100, title: '姓名' },
                            { field: '角色', width: 100, title: '角色' },
                            { field: '操作描述', width: 100, title: '操作描述' }
                        ]],
