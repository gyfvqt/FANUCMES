<%@ Page Title="" Language="C#" MasterPageFile="~/PageM.Master" AutoEventWireup="true" CodeBehind="PLCLogs.aspx.cs" Inherits="SM.WEB.Views.UserPermission.PLCLogs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label runat="server" ID="lblPage" Visible="false" Text="PLC交互日志"></asp:Label>
    ...
    <section id="main" role="main">
        ...
        <div style="height: 28px;">
            <span style="font-weight: bold; text-transform: uppercase; font-size: 16px; color: #444; float: left; margin-left: 12px; margin-top: 10px;">当前页面:系统管理\PLC交互日志</span>
        </div>
        <div class="RadAjaxPanel" style="display: block;">
            <div class="with-mid-padding" id="PortalContent_PnlContainer">
                <dl class="accordion toggle-mode" id="accordionCannedReport">
                    ...
                    <dt id="list-filter"><span id="PortalContent_Label1">PLC交互日志</span></dt>
    ...
    <script type="text/javascript">        
        ...
        function datagridfresh(pageNumber, pageSize, DTSTART, DTEND) {
            ...
            $.post('/Controller/PLClogs.ashx', { pageindex: pageNumber, pagesize: pageSize, dtstart: DTSTART, dtend: DTEND }, function (data) {
                ...
                if (data.rows[0].tips == "没有数据") {
                    ...
                    $("#datawin").datagrid({
                        ...
                        columns: [[
                            ...
                            { field: 'PLCIP', width: 100, title: '用户ID' },                            
                            { field: '操作描述',  title: '操作描述' }
                        ]],
