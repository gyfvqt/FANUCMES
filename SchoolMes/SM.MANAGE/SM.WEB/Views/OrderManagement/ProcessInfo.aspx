<%@ Page Title="" Language="C#" MasterPageFile="~/PageM.Master" AutoEventWireup="true" CodeBehind="ProcessInfo.aspx.cs" Inherits="SM.WEB.Views.OrderManagement.ProcessInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label runat="server" ID="lblPage" Visible="false" Text="过程质量查询"></asp:Label>
    <section id="main" role="main">
        ...
        <div style="height: 28px;">
            <span style="font-weight: bold; text-transform: uppercase; font-size: 16px; color: #444; float: left; margin-left: 12px; margin-top: 10px;">当前页面:订单管理\过程质量查询</span>
        </div>
                        ...
                        <div class="with-small-padding">
                            <div class="RadAjaxPanel" style="display: block; height: 100px; overflow-y: auto;">
                                <div>
                                    ...
                                    <div style="padding-bottom: .3em; font-weight: bold; float: left; text-transform: uppercase; font-size: 14px; color: #444;">过程质量描述:</div>
                                    <input id="txtPLCDataDesc" type="text" class="k-textbox" style="margin: 0 5px 5px 0; height: 26px; width: 120px; float: left;" />
    ...
    <script type="text/javascript">  
        ...
        function Search() {
            ...
            var PLCDataDesc = $("#txtPLCDataDesc").val().replace('/\,/g', '，').replace('/\:/g', '：').replace('/\;/g', '；');
            ...
            datagridfresh(1, 10, EndProductSN, ProductionId, ProductionName, PLCDataDesc, BeginTime, EndTime);
            gettotal(1, 10, EndProductSN, ProductionId, ProductionName, PLCDataDesc, BeginTime, EndTime);
        }
        function gettotal(pageNumber, pageSize, EndProductSN, ProductionId, ProductionName, PLCDataDesc, BeginTime, EndTime) {
            $.post('/Controller/PLCdefectCount.ashx', {
                pageindex: pageNumber,
                pagesize: pageSize,
                endProductSN: EndProductSN,
                productionCode: ProductionId,
                productionName: ProductionName,
                pLCDataDesc: PLCDataDesc,
                bgintime: BeginTime,
                endtime: EndTime
            }, function (data) {
                $('#datapager').pagination({
                    ...
                    onSelectPage: function (pageNumber, pageSize) {
                        ...
                        datagridfresh(pageNumber, pageSize, EndProductSN, ProductionId, ProductionName, PLCDataDesc, BeginTime, EndTime);
                    }
                });
            }, "json");
        }
        function datagridfresh(pageNumber, pageSize, EndProductSN, ProductionId, ProductionName, PLCDataDesc, BeginTime, EndTime) {
            $("#datawin").datagrid({
                url: "/Controller/PLCdefect.ashx?pageindex=" + pageNumber
                    + "&pagesize=" + pageSize
                    + "&endProductSN=" + EndProductSN
                    + "&productionCode=" + ProductionId
                    + "&productionName=" + ProductionName
                ...
                columns: [[
                    ...
                    { field: 'PLCDataDesc', width: 120, title: '过程质量描述', align: 'center' },
                    ...
                    {
                        field: 'PLCDataResult', width: 80, align: 'center', title: '质量状态',
            ...
            //$.post('/Controller/PLCdefect.ashx', {
            //    pageindex: pageNumber,
            //    pagesize: pageSize,
            //    endProductSN: EndProductSN,
            //    productionCode: ProductionId,
            ...
            //                var EndTime = $("#datetimePickerEnd").val();
            //                //var CreateTime = $("#dateCreateTime").val();
            //                datagridfresh(pageNumber, EndProductSN, ProductionId, ProductionName, PLCDataDesc, BeginTime, EndTime);
            //            }
            //        });
            //    }
            //}, "json");
