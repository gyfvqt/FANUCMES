<%@ Page Title="" Language="C#" MasterPageFile="~/PageM.Master" AutoEventWireup="true" CodeBehind="EndProduct.aspx.cs" Inherits="SM.WEB.Views.OrderManagement.EndProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label runat="server" ID="lblPage" Visible="false" Text="订单查询"></asp:Label>
    <section id="main" role="main">
        ...
        <div style="height: 28px;">
            <span style="font-weight: bold; text-transform: uppercase; font-size: 16px; color: #444; float: left; margin-left: 12px; margin-top: 10px;">当前页面:订单管理\订单查询</span>
        </div>
        <div class="RadAjaxPanel" style="display: block;">
            <div class="with-mid-padding" id="PortalContent_PnlContainer">
                <dl class="accordion toggle-mode" id="accordionCannedReport">
                        ...
                        <div class="with-small-padding">
                            <div class="RadAjaxPanel" style="display: block; height: 100px; overflow-y: auto;">
                                <div>
                                    ...
                                    <input id="txtERPDetailCode" type="text" class="k-textbox" style="margin: 0 5px 5px 0; height: 28px; width: 120px; float: left;" />
                                    ...
                                    <div style="padding-bottom: .3em; font-weight: bold; float: left; text-transform: uppercase; font-size: 14px; color: #444;">订单状态:</div>
                                    <select style="margin: 0 5px 5px 0; border: 1px solid #ccc; height: 28px; width: 120px;" id="sStatus">
                                        <option value="" selected="selected">请选择</option>
                                        <option value="2">已生成</option>
                                        <option value="3">已下达</option>
                                        <option value="4">已关闭</option>
                                    </select><br />
                                    <div style="padding-bottom: .3em; font-weight: bold; float: left; text-transform: uppercase; font-size: 14px; color: #444;">
                                        创建时间:
                                    <%--<input id="dateCreateTime" style="width: 120px; height: 28px;" />--%>
                                        <input id="dateCreateTime" class="Wdate " style="height: 26px;border-color: #c5c5c5;" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                                    </div>
                                    <div style="padding-bottom: .3em; font-weight: bold; float: left; text-transform: uppercase; font-size: 14px; color: #444;">
                                        生产下线时间   从:
                    ...
                    <dt id="list-filter"><span id="PortalContent_Label1">订单列表</span></dt>
    ...
    <script type="text/javascript">  
        ...
        function Search() {
            ...
            datagridfresh(1, 10, ERPDetailCode, Status, ProductionId, ProductionName, BeginTime, EndTime, CreateTime);
        }
        ...
        function datagridfresh(pageNumber, pageSize, ERPDetailCode, Status, ProductionId, ProductionName, BeginTime, EndTime, CreateTime) {
            $("#datawin").datagrid("loading");
            $.post('/Controller/ERPOrderDetailList.ashx',
                {
                    ...
                    if (data.rows[0].tips == "没有数据") {
                        ...
                        $("#datawin").datagrid({
                            ...
                            columns: [[
                                ...
                                { field: 'ERPDetailCode', width: 120, title: '订单编号', align: 'center', halign: 'left' },
                                { field: 'ProductionCode', width: 130, align: 'center', title: '产品编号' },
                                {
                                    field: 'SN', width: 100, align: 'center', halign: 'left', title: '生产顺序号'
                                },
                                {
                                    field: 'LineName', width: 130, align: 'center', title: '产线'
                                },
                                { field: 'ProductionName', width: 130, align: 'center', title: '产品名称' },
                                { field: 'DetailCount', width: 100, align: 'center', title: '订单数量' },
                                {
                                    field: 'Status', width: 100, align: 'center', title: '当前状态',
                                    formatter: function (value, row, index) {
                                        switch (row.Status) {
                        ...
                        $("#datawin").datagrid({
                            ...
                            columns: [[
                                ...
                                { field: 'ERPDetailCode', width: 150, title: '订单编号', align: 'center', halign: 'left' },
                                { field: 'ProductionCode', width: 130, align: 'center', title: '产品编号' },
                                {
                                    field: 'SN', width: 100, align: 'center', halign: 'left', title: '生产顺序号'
                                },
                        ...
                        $('#datapager').pagination({
                            ...
                            onSelectPage: function (pageNumber, pageSize) {
                                ...
                                var EndTime = $("#datetimePickerEnd").val();
                                var CreateTime = $("#dateCreateTime").val();
                                datagridfresh(pageNumber, pageSize, ERPDetailCode, Status, ProductionId, ProductionName, BeginTime, EndTime, CreateTime);
