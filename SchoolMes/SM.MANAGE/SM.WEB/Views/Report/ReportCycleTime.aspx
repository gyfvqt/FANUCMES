<%@ Page Title="" Language="C#" MasterPageFile="~/PageM.Master" AutoEventWireup="true" CodeBehind="ReportCycleTime.aspx.cs" Inherits="SM.WEB.Views.Report.ReportCycleTime" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="/Scripts/fanuc.js?id=<%=DateTime.Now.Ticks %>"></script>
    <script src="/My97DatePicker/WdatePicker.js"></script>
    <asp:Label runat="server" ID="lblPage" Visible="false" Text="Cycletime"></asp:Label>
    <section id="main" role="main">
        ...
        <div style="height: 28px;">
            <span style="font-weight: bold;  font-size: 16px; color: #444; float: left; margin-left: 12px; margin-top: 10px;">当前页面:设备维护\CycleTime</span>
        </div>
                            ...
                            <div class="RadAjaxPanel">
                                <div style="margin-top: 5px; margin-left: 5px;">
                                    ...
                                    <div style="float: left; margin-top: 5px; width: 100%;">
                                        <label id="ename" style="margin-left: 15px; font: bold 14px">选择节点：</label><asp:Label runat="server" ForeColor="Red">*</asp:Label>
                                    </div>
                                    <div style="float: left; margin-top: 5px; width: 100%;">
                                        ...
                                        <div style="float: left; margin-left: 15px;">
                                            <div style="float: left;">
                                                <input id="datetimePickerBegin" class="Wdate" style="border-color: #c5c5c5;" type="text" onclick="WdatePicker({ el: this, dateFmt: 'yyyy-MM-dd HH:mm:ss' })"><asp:Label runat="server" ForeColor="Red">*</asp:Label>
                                            </div>
                                            <span style="float: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    </span>
                                            <div style="float: left;">
                                                <input id="datetimePickerEnd" class="Wdate" style="border-color: #c5c5c5;" type="text" onclick="WdatePicker({ el: this, dateFmt: 'yyyy-MM-dd HH:mm:ss' })"><asp:Label runat="server" ForeColor="Red">*</asp:Label>
                                            </div>
                                        ...
                                        <button class="button white-gradient" id="new" style="margin-top: 2em; float: right; margin-right: 5px;" onclick="Query();return false;">查  询</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="dll" class="RadAjaxPanel" style="display: block; position: absolute; float: left; margin-top: 150px; margin-left: 220px;">
            <div class="with-mid-padding">
                <dl class="accordion toggle-mode" style="min-width: 840px; width: auto">
                    <dt class="closed"><span>Cycletime</span></dt>
                    <dd style="display: block;">
                        <div class="with-small-padding">
    ...
    <script type="text/javascript">
        ...
        function Query() {
            ...
            var Etype = $("#EType").val();
            var handler = "/Controller/ReportCycleTime.ashx?eid=" + $("#txtid").val() + "&dtstart=" + $("#datetimePickerBegin").val() + "&dtend=" + $("#datetimePickerEnd").val()+ "&etype=" + Etype;
            $('#datawin').datagrid({
                ...
                columns: [[
                    ...
                    { field: 'cycletime', title: 'CycleTime（sec）', width: 80 },
                ...
                onLoadSuccess: function (param) {
                    $(this).datagrid("autoMergeCells", ['EquipmentName','EId']);//相同设备合并单元格
                }
            });
