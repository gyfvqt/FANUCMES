<%@ Page Title="" Language="C#" MasterPageFile="~/PageM.Master" AutoEventWireup="true" CodeBehind="ReportFault.aspx.cs" Inherits="SM.WEB.Views.Report.ReportFault" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label runat="server" ID="lblPage" Visible="false" Text="故障和人工干预报表"></asp:Label>
    <section id="main" role="main">
        ...
        <div style="height: 28px;">
            <span style="font-weight: bold; text-transform: uppercase; font-size: 16px; color: #444; float: left; margin-left: 12px; margin-top: 10px;">当前页面:设备维护\故障和人工干预报表</span>
        </div>
    ...
    <script type="text/javascript">
        ...
        function Query(pageNumber, pageSize) {
            ...
            var handler = "/Controller/ReportFault.ashx?pageindex=" + page
            ...
            $('#datawin').datagrid({
                ...
                url: handler,
                columns: [[
                    { field: 'FaultDesc', title: '故障或人工干预描述', width: 150 },
