...
{
    /// <summary>
    /// getWeekGoodRate 的摘要说明
    /// </summary>
    public class getWeekGoodRate : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string sql = string.Format(@"select TTime,sum(case QualityStatus when 'OK' THEN 1 ELSE 0 END )*100/sum(1) AS RATE from(
