<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DHeader.aspx.cs" Inherits="SM.WEB.Station.DHeader" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="div">
                ...
                <div style="height: 100px;">
                    <span class="span">线体-生产监控仪表盘</span>
        ...
        <script type="text/javascript">
            ...
            function CheckInput() {
                ...
                if (stationid !== "") {
                    window.location.href = "Dashboard.aspx?id=" + stationid;
                }
                else {
                    alert("请先选线体")
                }
